...
// NewMeta advertises verb:kernel-param (plugin_input #KernelParamInput) + the embedded CUE
// schema, via sdk.NewMeta — the ONE meta both placements use (compiled-in registerCompiledCheckVerb
